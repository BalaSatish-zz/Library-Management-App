...
public class PersonsApplicationsActivity extends Activity {
    ...
    protected void onStart() {
        ...
        progressDialog.show();
        databaseReference = FirebaseDatabase.getInstance().getReference("Applications/"+Applicant+"/");
...
//                        Toast.makeText(BooksListActivity.this, ""+x, Toast.LENGTH_SHORT).show();
                    ...
                    BookReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            if(BooksList.size()==BookNames.size()){
                                ...
                                ApplicationListAdapterClass adapter = new ApplicationListAdapterClass(PersonsApplicationsActivity.this,BooksList);
    ...
    public void  Counter(){
        ...
        if(Count<0){
            recreate();
            Toast.makeText(PersonsApplicationsActivity.this, "Books Updated", Toast.LENGTH_SHORT).show();
            return;
        }
