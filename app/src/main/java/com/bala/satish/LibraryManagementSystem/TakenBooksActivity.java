...
public class TakenBooksActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Applicant = (FirebaseAuth.getInstance().getCurrentUser().getEmail()).replace("@gmail.com","");
...
//                        Toast.makeText(BooksListActivity.this, ""+x, Toast.LENGTH_SHORT).show();
                    ...
                    BookReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            if(BooksList.size()==BookNames.size()){
                                ...
                                TakenBooksListAdapterClass adapter = new TakenBooksListAdapterClass(TakenBooksActivity.this,BooksList);
    ...
    public void  Counter(){
        ...
        if(Count<0){
            recreate();
            Toast.makeText(TakenBooksActivity.this, "List Updated", Toast.LENGTH_SHORT).show();
            return;
        }
