...
public class EmailsListAdapterClass2 extends ArrayAdapter<String>{
    private Activity context;
    private List<String> EmailsList;

    public EmailsListAdapterClass2(Activity context, List<String> EmailsList){
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        textViewEmailName.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(context,ApprovedBooksActivity2.class);
