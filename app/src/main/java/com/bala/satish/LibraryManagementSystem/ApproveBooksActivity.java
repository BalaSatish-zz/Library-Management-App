...
public class ApproveBooksActivity extends Activity {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot child: dataSnapshot.getChildren()){
                    ...
                    EmailsList.add(x);
                    Toast.makeText(ApproveBooksActivity.this, ""+x, Toast.LENGTH_SHORT).show();
                }
                EmailsListAdapterClass adapter = new EmailsListAdapterClass(ApproveBooksActivity.this,EmailsList);
